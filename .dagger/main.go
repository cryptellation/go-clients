...
func (mod *GoClient) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (mod *GoClient) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (mod *GoClient) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
